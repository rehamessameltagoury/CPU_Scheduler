...
# Form implementation generated from reading ui file 'E:\year 3(2nd)\OS\design\priority_preem_info.ui'
#
...
class Ui_priority_preem_info(object):
    ...
    def retranslateUi(self, priority_preem_info):
        ...
        priority_preem_info.setWindowTitle(_translate("priority_preem_info", "CPU Scheduler"))
